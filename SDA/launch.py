...
def launch_wnd(config):
    ...
    def parse_args():
        ...
        parser.add_argument('--training_set_size', type=int, default=TRAIN_DATASET_SIZE,
    ...
    cmd += f"--train_data_pattern {args.train_data_pattern} --eval_data_pattern {args.eval_data_pattern} --transformed_metadata_path {args.transformed_metadata_path} " \
