...
def parse_args():
    ...
    locations.add_argument('--train_data_path', type=str, default='/outbrain/tfrecords/train/train.bin',
                           help='Train data path')

    locations.add_argument('--eval_data_path', type=str, default='/outbrain/tfrecords/eval/valid.bin',
    ...
    training_params.add_argument('--warmup_steps', type=float, default=5000,
