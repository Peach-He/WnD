...
# time mpirun -genv OMP_NUM_THREADS=16 -map-by socket -n 1 -ppn 1 -hosts sr113 -print-rank-map \
# -genv I_MPI_PIN_DOMAIN=socket -genv OMP_PROC_BIND=true -genv KMP_BLOCKTIME=1 -genv KMP_AFFINITY=granularity=fine,compact,1,0 \
# -iface eth3 \
/root/sw/miniconda3/envs/wd2/bin/python main.py \
  --train_data_path /mnt/nvm6/recsys/train.bin \
  --eval_data_path /mnt/nvm6/recsys/valid.bin \
  --model_dir /mnt/nvm6/wd/recsys \
  --cpu \
