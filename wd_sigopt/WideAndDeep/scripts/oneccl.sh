...
time horovodrun -np 4 -H sr113:2,sr112:2 --network-interface eth3 --timeline-filename timeline.json \
--mpi-args="-x OMP_NUM_THREADS=16 -map-by socket" \
/root/sw/miniconda3/envs/wd2noccl/bin/python main.py \
